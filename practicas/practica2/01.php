...
echo "A. </br>" ,$coches[5],"</br></br>";

$importe = array (32.583, 11.239, 45.781, 22.237);
echo "B. </br>",$importe[1],"</br>";
echo $importe[3],"</br></br>";

$confirmado = array (true, true, false, true, false, false);
if ($confirmado[0] == true) {
    echo "C. </br> True </br></br>";
}

$jugador = array ("Crovic", "Antic", "Malic", "Zulic", "Rostrich");
echo "D. </br> La alineación del equipo está compuesta por ".$jugador[0].", ".$jugador[1].", ".$jugador[2].", ".$jugador[3]." y ".$jugador[4].".";
