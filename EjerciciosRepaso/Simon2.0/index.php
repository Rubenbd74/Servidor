...
<!-- Este es el formulario en HTML, en el recogemos el 
usuario y la contraseña en el form el action tiene que ser 
una almohadilla porque el php está en el mismo archivo.-->
